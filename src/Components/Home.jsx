...
function Home (){
  ...
  return (
    <>
        ...
        <p>Explora la mejor selección de celulares de las marcas más reconocidas del mercado. Aquí encontrarás dispositivos de última generación, con las últimas tecnologías y a precios que se ajustan a tu presupuesto. Ya sea que busques potencia, cámara, diseño o duración de batería, en CeluStar tenemos el celular perfecto para vos. ¡Descubrí, compará y elegí el tuyo con confianza! Porque conectarte con lo que más importa nunca fue tan fácil.</p>
        <Slider {...settings}>
        {fotos.map((foto, i) => (
            <div key={i}>
            <img src={foto} alt={`Foto ${i + 1}`} style={{ width: "100%" }} />
            </div>
        ))}
        </Slider>
